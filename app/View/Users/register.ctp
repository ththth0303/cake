...
<form class="form-horizontal" method="post" action="check_register">
	<fieldset>
  ...
  <input id="textinput" name="re_password" type="password" placeholder="Re Password" class="form-control input-md">
  <!-- <div class="spacing"><input type="checkbox" name="checkboxes" id="checkboxes-0" value="1"><small> Remember me</small></div> -->
  <button id="singlebutton" name="singlebutton" class="btn btn-info btn-sm pull-right">Sign Up</button>
